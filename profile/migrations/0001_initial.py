    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('klas', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='classrooms.ClassRoom')),
                ('klas_ouder', models.ManyToManyField(blank=True, related_name='klasouders', to='classrooms.ClassRoom')),
                ('klasleerkracht', models.ManyToManyField(blank=True, related_name='leerkracht', to='classrooms.ClassRoom')),
                ('parents', models.ManyToManyField(blank=True, related_name='_profile_parents_+', to=settings.AUTH_USER_MODEL)),
